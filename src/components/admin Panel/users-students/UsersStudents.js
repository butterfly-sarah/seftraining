...
function UserStudents(){
    ...
    return(
        ...
        <div class="article-sec  ">
          <button className="btn ps-4 m-2 d-block pe-4 p-2 ms-auto" style={{transform:'translateY(-50px)',border:"1px solid #bf9b30",color:"#bf9b30"}}> Create new user</button>
                ...
                <table class="  table table-borderless text-light mx-auto table-responsive-sm    ">
                  ...
                  <tr>
                    ...
                    <FontAwesomeIcon icon={faPenToSquare} style={{color:"#bf9b30"}} />
                     ...
                     <Link href="">
                        <FontAwesomeIcon icon={faTrashCan} style={{color:"#bf9b30"}} />
                        </Link>
                    </td>
                </tr>
                <tr>
