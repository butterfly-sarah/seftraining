...
function AdminSideBar(){
  const [cirtificateBtn ,setCertifiCateeBtn] = useState(false)
    return(
        ...
        <div className='parent-users'>
          <h5 onClick={()=>setCertifiCateeBtn(false)}><Link to="Jobbs">Jobs</Link></h5>
        ...
        {
          cirtificateBtn ?<Link to="addCertificate" > <button className='btn text-light w-100 add'> Add Certificate</button></Link>:''
        }
