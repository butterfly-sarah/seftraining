...
function Personal(){
    ...
    <div class="exams-container position-relative mt-3 ">
        ...
        <span class="text-uppercase" style={{color:"#bf9b30"}}> BALQEES SABER</span>
        </div>
        ...
        <div class="row text-light mt-5 container mx-auto justify-content-between">
            <div class="col-xs-12 col-md-5 mb-3">
                ...
                <div class="course mt-3 p-4">
                    <h6 style={{fontWeight:"700"}} className='mb-1'>Introdution to Date Analysis</h6>
                    <div>
                    <span class="course_coler" style={{fontWeight:"700"}}>Instructor: </span>
                    <span>Tarik Ali </span>
                    </div>
                    <div class="d-flex justify-content-between mt-4">
                    <div class="" style={{fontWeight:"700"}}>LEV.1</div>
                    <Link to={"/StudentPanel/coursedetails"} className=''>
                    <button class="rounded border-0 course_button text-light px-3 py-1 font-weight-bold">VIEW DETAILS</button></Link>
                    </div>
                </div>
                <div class="course mt-3 p-4">
                    <h6 style={{fontWeight:"700"}} className='mb-1'>Introduction to Date Analysis</h6>
                    <div>
                    <span class="course_coler" style={{fontWeight:"700"}}>Instructor: </span>
                    <span>Tarik Ali </span>
                    </div>
        ...
        <div class="mb-3 mt-5 container  text-light">
          <h4 style={{fontWeight:"700"}} className='my-4'>Earned Certificates</h4>
          <div className='d-flex  course justify-content-between align-items-center p-3'>
            <div className=''>
                <h5 style={{fontWeight:"700"}}>Introduction to React js</h5>
                <span>
                <span class="course_coler" style={{fontWeight:"700"}}>Instructor: </span>
                <span>Tariq Ali </span>
                </span>
                <span className='ms-sm-0 ms-md-3 d-m-block'>
                <span class="course_coler" style={{fontWeight:"700"}}>Date Acquired: </span>
                <span>Monday, June 5th </span>
                </span>
            </div>
            <div className='d-flex h-50'>
                <button className='rounded border-0  course_button text-light px-4 py-2 font-weight-bold'>Download</button>
            </div>
        </div>
        </div>
